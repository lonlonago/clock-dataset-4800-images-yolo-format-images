# Clock dataset (4800 images) YOLO format images

# Body

Clock dataset, 4800 images in YOLO format, with clear images and complete annotations, suitable for target detection, image segmentation, algorithm performance testing, etc., ready to use directly, saving time and effort.
